...
export default async function AllBlogsPage() {
    ...
    if (error) {
        return <div className="p-10 text-red-600 text-center">Fout bij het laden van de artikelen</div>;
    }
    ...
    return (
        <div className="max-w-6xl mx-auto px-4 py-10" dir="ltr">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {blogs?.map((blog) => (
                    <div key={blog.id} className="bg-white border border-gray-200 rounded-xl p-4 shadow-md">
                        {blog.image_urls?.[0] && (
                            <img
                        ...
                        <h2 className="text-lg font-semibold text-purple-800">{blog.title}</h2>
