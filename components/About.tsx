    ...
    return (
        <section id="about" className="bg-white py-20 px-4">
            <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center text-left">
                {/* Text Content */}
                <div>
                    <h2 className="text-3xl font-bold text-purple-700 mb-6">📌 Wie zijn wij?</h2>
                    ...
                    <h3 className="text-xl font-semibold text-purple-600 mt-6 mb-2">🌟 Waarom kiezen voor ons?</h3>
                    ...
                    <h3 className="text-xl font-semibold text-purple-600 mt-6 mb-2">🎯 Onze visie en missie</h3>
                    <p><strong>Onze visie:</strong> De nummer één keuze zijn voor reizigers die Europa willen ontdekken.</p>
                    <p><strong>Onze missie:</strong> Betrouwbare en hoogwaardige toeristische diensten aanbieden die voldoen aan de behoeften van alle reizigers, met een focus op innovatie, comfort en unieke ervaringen.</p>
                </div>
