            ...
            <section id="services" className="bg-gray-50 py-16">
                <div className="container mx-auto px-4">
                    ...
                    <div className="text-center mb-12 max-w-3xl mx-auto">
                        <h2 className="text-3xl font-bold text-[#11999D] mb-4">Onze Speciale Diensten</h2>
                    ...
                    <div className="grid gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div className="bg-white p-6 rounded-xl shadow hover:-translate-y-2 transition-all text-left">
                            <div className="w-14 h-14 flex items-center justify-center rounded-full bg-[#11999D] text-white text-xl mb-4 mx-auto">
                                <FaPlane />
                            </div>
                            <h3 className="text-xl font-bold mb-2 text-black">Speciale Toeristische Programma&apos;s</h3>
                        ...
                        <div className="bg-white p-6 rounded-xl shadow hover:-translate-y-2 transition-all text-left">
                            ...
                            <h3 className="text-xl font-bold mb-2 text-black">Ontvangst van Delegaties</h3>
                        ...
                        <div className="bg-white p-6 rounded-xl shadow hover:-translate-y-2 transition-all text-left">
                            ...
                            <h3 className="text-xl font-bold mb-2 text-black">Vlucht- en Hotelboekingen</h3>
